...
pub struct BorrowStack<'a, T: 'a, U: 'a> {
    container: *mut T,
    member: *mut U,
    _phantom: std::marker::PhantomData<&'a mut T>,
}

unsafe impl<'a, T: 'a + Send, U: 'a + Send> Send for BorrowStack<'a, T, U> {}

impl<'a, T: 'a, U: 'a> BorrowStack<'a, T, U> {
...
impl<'a, T: 'a, U: 'a + fmt::Debug> fmt::Debug for BorrowStack<'a, T, U> {
